...
> **Snapshot: 2026-05-06.** Archived 2026-05-09 — many showstoppers (e.g. "is the loop fun to watch?") have been substantially answered by the action-driven raid pivot. Kept for reference; do not treat as current.
...
Companion docs:
- `PLAN.md` — Phase 1 execution plan (locked scope)
...
Tarkov's atmosphere is ~80% audio. Text-only "tense raid" fights uphill. Deferring audio to Phase 5+ is probably too late for the v1 vibe to land.
